...
CREATE TABLE PLACE (
	...
	ID_COMPTE_SERVEUR INT8,
	CONSTRAINT CST_PK_PLACE PRIMARY KEY (ID),
	--CONSTRAINT CST_DOM_COMMANDE_DATETIME_RESERVATION CHECK (DATETIME_RESERVATION >= NOW()),
	CONSTRAINT CST_DOM_ETAT CHECK (ETAT IN ('libre','sale','réservé','occupé')),
...
CREATE TABLE COMMANDE (
    ...
    --CONSTRAINT CST_DOM_COMMANDE_DATETIME_CREATION CHECK (DATETIME_CREATION >= NOW()),
	CONSTRAINT CST_DOM_ETAT CHECK (ETAT IN ('en attente','servi','payé')), 
...
CREATE TABLE PLAT_INGREDIENTS (
	...
	CONSTRAINT UNQ_ID_PLAT_ID_INGREDIENT UNIQUE (ID_PLAT , ID_INGREDIENT),
...
CREATE TABLE LIGNE_COMMANDE (
	...
	CONSTRAINT CST_DOM_ETAT CHECK (ETAT IN ('en attente','prêt')),
	CONSTRAINT UNQ_ID_PLAT_ID_COMMANDE UNIQUE (ID_PLAT , ID_COMMANDE),
...
--création de la table stat chiffre d'affaire
CREATE TABLE STAT_CHIFFRE_AFFAIRE (
	ID SERIAL8 NOT NULL,
	DATE_JOUR DATE  NOT NULL,
	CHIFFRE_AFFAIRE_DEJEUNER DECIMAL(16,3) NULL,
	CHIFFRE_AFFAIRE_DINER DECIMAL(16,3) NULL,
	CHIFFRE_AFFAIRE DECIMAL(16,3) NULL,
	ID_PLAT INT8 NOT NULL,
	CONSTRAINT CST_PK_STAT_CHIFFRE_AFFAIRE PRIMARY KEY (ID),
	CONSTRAINT CST_FK_COMPTE_ID_PLAT FOREIGN KEY (ID_PLAT) REFERENCES PLAT(ID)
);

--création de la table stat general
CREATE TABLE STAT_GENERAL (
	ID SERIAL8 NOT NULL,
	DATE_JOUR DATE  NOT NULL,
	TEMPS_PREPARATION DECIMAL(16,3) NULL,
	NB_COMMANDES INT8 NULL,
	NB_CLIENTS INT8 NULL,
	CONSTRAINT CST_PK_STAT_GENERAL PRIMARY KEY (ID)
);